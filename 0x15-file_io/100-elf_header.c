...
/**
 * check_elf - checking if file is an ELF file
 * @e_ident: pointer to an array containing the ELF magic numbers
 *
 * Description: If filee is not an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: pointer to an array containing the ELF magic numbers
 *
 * Description: magic numbers been separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: pointertoarray containing ELF ABI version
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - to print the type of ELF header
 * @e_type: here lies the ELF type
 * @e_ident: pointertoarray containing ELF class
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * print_entry - to print entry point of ELF header
 * @e_entry:  address of the ELF entry point
 * @e_ident: pointer to array containingELF class
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main - displaying the information contained in the
